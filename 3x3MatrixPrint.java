...
/*# sourceURL=ace/css/ace_scrollbar.css */</style>
  ...
  <link rel="stylesheet" href="./3x3MatrixPrint_files/fonts.css">
  ...
  <script async="" src="./3x3MatrixPrint_files/clarity.js.download"></script><script async="" src="./3x3MatrixPrint_files/kl8gh6lk26"></script><script type="text/javascript" async="" src="./3x3MatrixPrint_files/analytics.js.download"></script><script type="text/javascript" async="" src="./3x3MatrixPrint_files/js"></script><script async="" src="./3x3MatrixPrint_files/gtm.js.download"></script><script>
  ...
  <link href="./3x3MatrixPrint_files/css2" rel="stylesheet">
  <link rel="stylesheet" href="./3x3MatrixPrint_files/styles.94228e21d5ec9bcb89cf.css">
  <!-- Global site tag (gtag.js) - Google Analytics -->

<script src="./3x3MatrixPrint_files/mode-java.js.download"></script></head>
        ...
        <div class="nav-header-wrapper">
          <div class="nav-logo-title-wrapper">
            <a href="https://www.programiz.com/" target="_blank" class="nav-logo-link">
              <img id="nav-logo" src="./3x3MatrixPrint_files/logo.svg">
            </a>
          </div>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M29.9196 33.8549C32.0265 33.0205 36.1973 31.7405 38.4533 35.8806C38.9712 36.8532 40.1207 31.7059 35.9618 26.8506L35.8873 26.7661C35.9081 26.6956 35.9286 26.6286 35.9487 26.5631C35.9889 26.4317 36.0272 26.3061 36.0638 26.1702C38.159 18.6894 33.1565 9.75527 24.7445 5C28.3777 9.66308 30.0412 15.2949 28.5857 20.25C28.4536 20.7083 28.2951 21.1588 28.1109 21.5995C27.9383 21.4841 27.7225 21.361 27.4439 21.2149C21.1601 17.3644 15.3113 12.871 9.99608 7.81009C13.1936 12.2165 16.7354 16.3731 20.5896 20.2423C17.8902 18.7855 10.3022 13.638 5.53115 9.5593C6.1325 10.4985 6.82774 11.3767 7.60662 12.181C11.5537 16.9401 16.8504 22.768 23.0888 27.2504C18.7062 29.7914 12.4836 29.9798 6.257 27.2504C4.73944 26.619 3.30917 25.8028 2 24.8209C4.81703 28.9559 8.83711 32.1663 13.539 34.0355C19.5694 36.4535 25.5607 36.2113 29.9196 33.8549Z" fill="#25265E" fill-opacity="0.67"></path>
    ...
    <div class="notification " id="notification" style="display:none;">
      <div class="check-icon-wrapper">
        <img src="./3x3MatrixPrint_files/check.svg" alt="check">
      </div>
          ...
          <div class="logo-wrapper">
            <h1 class="logo-title-wrapper">
              <a href="https://www.programiz.com/" target="_blank" class="logo-link">
                <img id="logo" src="./3x3MatrixPrint_files/logo.svg">
...
<path d="M11.5584 4.88281L6.44336 7.86781" stroke="white" stroke-width="1.77778" stroke-linecap="round" stroke-linejoin="round"></path>
        ...
        <div class="other-options-wrapper">
          ...
          <div class="mobile-top-bar-run-button run"><img src="./3x3MatrixPrint_files/play.svg" alt="run-icon"></div>
        </div>
      </div>
...
<path d="M11.5584 4.88281L6.44336 7.86781" stroke="white" stroke-width="1.77778" stroke-linecap="round" stroke-linejoin="round"></path>
        ...
        <div id="editor" class=" ace_editor ace-tm ace_focus" style="font-family: &quot;Droid Sans Mono&quot;; font-size: 14px; line-height: 22px; height: 602.667px;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" aria-haspopup="false" aria-autocomplete="both" role="textbox" aria-label="Cursor at row 16" style="opacity: 0; font-size: 1px; height: 1px; width: 1px; top: 339px; left: 130px;"></textarea><div class="ace_gutter" aria-hidden="true" style="left: 0px; width: 50px;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="height: 1e+06px; top: -13px; left: 0px; width: 50px;"><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 0px;">1<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 22px;">2<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 44px;">3<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="false" style="height: 22px; top: 66px;">4<span tabindex="-1" style="display: inline-block; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code" role="button" aria-label="Toggle code folding, row 4"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="false" style="height: 22px; top: 88px;">5<span tabindex="-1" style="display: inline-block; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code" role="button" aria-label="Toggle code folding, rows 5 through 28"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="false" style="height: 22px; top: 110px;">6<span tabindex="-1" style="display: inline-block; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code" role="button" aria-label="Toggle code folding, rows 6 through 27"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 132px;">7<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 154px;">8<span class="ace_fold-widget ace_start ace_open" tabindex="0" aria-expanded="true" title="Fold code" style="height: 22px; display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 176px;">9<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 198px;">10<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="false" style="height: 22px; top: 220px;">11<span tabindex="-1" style="display: inline-block; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code" role="button" aria-label="Toggle code folding, rows 11 through 16"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 242px;">12<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="false" style="height: 22px; top: 264px;">13<span tabindex="-1" style="display: inline-block; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code" role="button" aria-label="Toggle code folding, rows 13 through 15"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 286px;">14<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 308px;">15<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-active-line ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 330px;">16<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 352px;">17<span tabindex="0" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code" style="display: none; height: 22px;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 374px;">18<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 396px;">19<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="false" style="height: 22px; top: 418px;">20<span tabindex="-1" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code" style="display: inline-block; height: 22px;" role="button" aria-label="Toggle code folding, rows 20 through 26"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 440px;">21<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="false" style="height: 22px; top: 462px;">22<span tabindex="-1" style="display: inline-block; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code" role="button" aria-label="Toggle code folding, rows 22 through 24"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 484px;">23<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 506px;">24<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 528px;">25<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 550px;">26<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 572px;">27<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 594px;">28<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div></div></div><div class="ace_scroller " style="line-height: 22px; left: 50px; right: 15px; bottom: 0px;"><div class="ace_content" style="top: -13px; left: 0px; width: 817px; height: 646.667px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 676px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height: 22px; top: 330px; left: 0px; right: 0px;"></div><div class="ace_bracket ace_start ace_br15" style="height: 22px; width: 8.40234px; top: 330px; left: 71.2188px;"></div><div class="ace_bracket ace_start ace_br15" style="height: 22px; width: 8.40234px; top: 220px; left: 71.2188px;"></div></div><div class="ace_layer ace_text-layer" style="height: 1e+06px; margin: 0px 4px; top: 0px; left: 0px;"><div class="ace_line_group" style="height: 22px; top: 0px;"><div class="ace_line" style="height: 22px;"><span class="ace_comment">// Online Java Compiler</span></div></div><div class="ace_line_group" style="height: 22px; top: 22px;"><div class="ace_line" style="height: 22px;"><span class="ace_comment">// Use this editor to write, compile and run your Java code online</span></div></div><div class="ace_line_group" style="height: 22px; top: 44px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 66px;"><div class="ace_line" style="height: 22px;"><span class="ace_keyword">import</span> <span class="ace_identifier">java</span>.<span class="ace_identifier">util</span>.<span class="ace_keyword ace_operator">*</span>;</div></div><div class="ace_line_group" style="height: 22px; top: 88px;"><div class="ace_line" style="height: 22px;"><span class="ace_keyword">class</span> 3<span class="ace_identifier">x3MatrixPrint</span> {</div></div><div class="ace_line_group" style="height: 22px; top: 110px;"><div class="ace_line" style="height: 22px;">    <span class="ace_keyword">public</span> <span class="ace_keyword">static</span> <span class="ace_keyword">void</span> <span class="ace_entity ace_name ace_function">main</span>(<span class="ace_support ace_function">String</span>[] <span class="ace_identifier">args</span>) {</div></div><div class="ace_line_group" style="height: 22px; top: 132px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_identifier">Scanner</span> <span class="ace_identifier">sc</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_keyword">new</span> <span class="ace_entity ace_name ace_function">Scanner</span>(<span class="ace_support ace_function">System</span>.<span class="ace_identifier">in</span>);</div></div><div class="ace_line_group" style="height: 22px; top: 154px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_keyword">int</span>[][] <span class="ace_identifier">a</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_keyword">new</span> <span class="ace_keyword">int</span>[<span class="ace_constant ace_numeric">3</span>][<span class="ace_constant ace_numeric">3</span>];</div></div><div class="ace_line_group" style="height: 22px; top: 176px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_support ace_function">System</span>.<span class="ace_identifier">out</span>.<span class="ace_entity ace_name ace_function">println</span>(<span class="ace_string">"Enter matrix"</span>);</div></div><div class="ace_line_group" style="height: 22px; top: 198px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_keyword">for</span>(<span class="ace_keyword">int</span> <span class="ace_identifier">i</span><span class="ace_keyword ace_operator">=</span><span class="ace_constant ace_numeric">0</span>; <span class="ace_identifier">i</span><span class="ace_keyword ace_operator">&lt;</span><span class="ace_constant ace_numeric">3</span>; <span class="ace_identifier">i</span><span class="ace_keyword ace_operator">++</span>)</div></div><div class="ace_line_group" style="height: 22px; top: 220px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    {</div></div><div class="ace_line_group" style="height: 22px; top: 242px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide ace_indent-guide-active">    </span>    <span class="ace_keyword">for</span>(<span class="ace_keyword">int</span> <span class="ace_identifier">j</span><span class="ace_keyword ace_operator">=</span><span class="ace_constant ace_numeric">0</span>;<span class="ace_identifier">j</span><span class="ace_keyword ace_operator">&lt;</span><span class="ace_constant ace_numeric">3</span>;<span class="ace_identifier">j</span><span class="ace_keyword ace_operator">++</span>)</div></div><div class="ace_line_group" style="height: 22px; top: 264px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide ace_indent-guide-active">    </span>    {</div></div><div class="ace_line_group" style="height: 22px; top: 286px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide ace_indent-guide-active">    </span><span class="ace_indent-guide">    </span>    <span class="ace_identifier">a</span>[<span class="ace_identifier">i</span>][<span class="ace_identifier">j</span>] <span class="ace_keyword ace_operator">=</span> <span class="ace_identifier">sc</span>.<span class="ace_entity ace_name ace_function">nextInt</span>();</div></div><div class="ace_line_group" style="height: 22px; top: 308px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide ace_indent-guide-active">    </span>    }</div></div><div class="ace_line_group" style="height: 22px; top: 330px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    }</div></div><div class="ace_line_group" style="height: 22px; top: 352px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>   </div></div><div class="ace_line_group" style="height: 22px; top: 374px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_support ace_function">System</span>.<span class="ace_identifier">out</span>.<span class="ace_entity ace_name ace_function">println</span>(<span class="ace_string">"Enter 3x3 Matrix"</span>);</div></div><div class="ace_line_group" style="height: 22px; top: 396px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_keyword">for</span>(<span class="ace_keyword">int</span> <span class="ace_identifier">i</span><span class="ace_keyword ace_operator">=</span><span class="ace_constant ace_numeric">0</span>; <span class="ace_identifier">i</span><span class="ace_keyword ace_operator">&lt;</span><span class="ace_constant ace_numeric">3</span>; <span class="ace_identifier">i</span><span class="ace_keyword ace_operator">++</span>)</div></div><div class="ace_line_group" style="height: 22px; top: 418px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    {</div></div><div class="ace_line_group" style="height: 22px; top: 440px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_keyword">for</span>(<span class="ace_keyword">int</span> <span class="ace_identifier">j</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_constant ace_numeric">0</span>; <span class="ace_identifier">j</span><span class="ace_keyword ace_operator">&lt;</span><span class="ace_constant ace_numeric">3</span>; <span class="ace_identifier">j</span><span class="ace_keyword ace_operator">++</span>)</div></div><div class="ace_line_group" style="height: 22px; top: 462px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    {</div></div><div class="ace_line_group" style="height: 22px; top: 484px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_support ace_function">System</span>.<span class="ace_identifier">out</span>.<span class="ace_entity ace_name ace_function">print</span>(<span class="ace_identifier">a</span>[<span class="ace_identifier">i</span>][<span class="ace_identifier">j</span>]<span class="ace_keyword ace_operator">+</span> <span class="ace_string">" "</span>);</div></div><div class="ace_line_group" style="height: 22px; top: 506px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    }</div></div><div class="ace_line_group" style="height: 22px; top: 528px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_support ace_function">System</span>.<span class="ace_identifier">out</span>.<span class="ace_entity ace_name ace_function">println</span>();</div></div><div class="ace_line_group" style="height: 22px; top: 550px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    }</div></div><div class="ace_line_group" style="height: 22px; top: 572px;"><div class="ace_line" style="height: 22px;">    }</div></div><div class="ace_line_group" style="height: 22px; top: 594px;"><div class="ace_line" style="height: 22px;">}</div></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_animate-blinking"><div class="ace_cursor" style="display: block; top: 330px; left: 80px; width: 8px; height: 22px; animation-duration: 1000ms;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="width: 20px; height: 602.667px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 20px; height: 616px;">&nbsp;</div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 20px; left: 50px; right: 15px; width: 817px;"><div class="ace_scrollbar-inner" style="height: 20px; width: 817px;">&nbsp;</div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;">הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה</div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; font-optical-sizing: inherit; font-size-adjust: inherit; font-kerning: inherit; font-feature-settings: inherit; font-variation-settings: inherit; font-language-override: inherit; overflow: visible;"></div></div><div class="ace_tooltip" role="tooltip" style="display: none; pointer-events: auto;"></div></div>
      </div>
  ...
  <!-- The use of the cloudflare cdn for all external libraries is intential. We are trying to reduce the number
         of DNS lookups.
    -->
  <script defer="" src="./3x3MatrixPrint_files/socket.io.min.js.download"></script>
  <script defer="" src="./3x3MatrixPrint_files/jquery.min.js.download"></script>

  <script defer="" src="./3x3MatrixPrint_files/ace.js.download"></script>
  <script defer="" src="./3x3MatrixPrint_files/mousetrap.min.js.download"></script>
  <script defer="" src="./3x3MatrixPrint_files/final.9788bef3345cc979828c.js.download"></script>
